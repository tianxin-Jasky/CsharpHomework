            ...
            while (sss != "@")
            {
                ...
                switch (operationNum)
                {
                    case 1:       //利用foreach将所有的订单输出
                        ...
                        {
                            Console.WriteLine(i.ClientName + "  订单号：" + i.Number + "  苹果的个数" + i.AppleNum + "  球的个数" + i.BallNum + "  笔的个数" + i.PenNum);
                        }
                        break;                             
                    case 2:         //添加订单
                    ...
                    case 4:
                        ...
                        switch (qq)
                        {
                            case 1:
                                ...
                                Console.WriteLine(o41.ClientName + "  订单号：" + o41.Number + "  苹果的个数" + o41.AppleNum + "  球的个数" + o41.BallNum + "  笔的个数" + o41.PenNum);
                                break;
                            case 2:
                                Console.WriteLine("输入：");
...
class OrderService
{
    ...
    public Order SearchOrderName(string ClientName)
    {
        ...
        {
            if (i.ClientName == ClientName) O1=i;
        }
        return O1;
    }
    //按照订单号查询
